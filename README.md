...
Последняя проверка локальной статической release-сборки (10.08.2026): Lighthouse mobile —
**100/100/100/100** (Performance/Accessibility/Best Practices/SEO) на главной, каталоге и
`among_us`; CLS 0, LCP 0.5 с / 0.5 с / 0.4 с соответственно. Метрики на выбранном боевом хосте
нужно повторно снять после переключения DNS.
